<?xml version="1.0"?>
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n3="http://www.w3.org/1999/xhtml" xmlns:n1="urn:hl7-org:v3" xmlns:n2="urn:hl7-org:v3/meta/voc" xmlns:voc="urn:hl7-org:v3/voc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
...
<xsl:template match="n1:ClinicalDocument">
		...
		<xsl:for-each select="/n1:ClinicalDocument/n1:documentationOf">
		    <xsl:variable name="uid" select="n1:serviceEvent/n1:templateId/@root"/>
			<xsl:if test="$uid='1.3.6.1.4.1.19376.1.5.3.1.2.6'">
			<b><xsl:text>Consent with policy: </xsl:text></b>
			<xsl:value-of select="n1:serviceEvent/n1:code/@displayName"/>
			<br/>
			<b><xsl:text>Duration from: </xsl:text></b>
			<xsl:value-of select="n1:serviceEvent/n1:effectiveTime/n1:low/@value"/>
			<xsl:if test="n1:serviceEvent/n1:effectiveTime/n1:high">
				<b><xsl:text> to: </xsl:text></b>
				<xsl:value-of select="n1:serviceEvent/n1:effectiveTime/n1:high/@value"/>
			</xsl:if>			
			<br/>
			</xsl:if>
		</xsl:for-each>
